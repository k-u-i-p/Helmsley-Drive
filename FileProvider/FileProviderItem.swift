...
final class FileProviderItem: NSObject, NSFileProviderItem {
    ...
    static func folder(in container: ItemIdentity, remote: RemoteFolder) -> FileProviderItem {
    ...
    static func file(in container: ItemIdentity, remote: RemoteFile) -> FileProviderItem {
        ...
        return FileProviderItem(
            ...
            capabilities: capabilities(forPersonal: identity.isPersonal, folder: false, trashed: false),
    ...
    static func personal(_ remote: RemoteFile) -> FileProviderItem {
        ...
        return FileProviderItem(
            ...
            capabilities: capabilities(forPersonal: true, folder: remote.isFolder, trashed: remote.isTrashed),
    ...
    /// something is trashed, so they are not offered here either.
    private static func capabilities(forPersonal personal: Bool, folder: Bool, trashed: Bool) -> NSFileProviderItemCapabilities {
